    ...
    <>
      {js && (
        <Item
          ...
          data-url={!!item.data[state.priceCode] ? `https://markets.myjam.store/store/${state.priceCode}/products` : `https://markets.myjam.store/products`}
        ...
        >
          <img
            src={`https://res.cloudinary.com/${process.env.GATSBY_CLOUDINARY_KEY}/image/upload/${process.env.GATSBY_CLOUDINARY_PATH}/markets/${item.data.sku}.jpg`}
            alt={item.data.name}
          />
          <h3 className="price">
          ...
          <QuantityBoxMobile>
            ...
            <div>
              <button
                ...
                data-item-url={!!item.data[state.priceCode] ? `https://markets.myjam.store/store/${state.priceCode}/products` : `https://markets.myjam.store/products`}
