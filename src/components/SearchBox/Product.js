...
const Product = React.memo(({ item }) => {
  ...
  return (
    <Item
      ...
      data-url={!!item[state.priceCode] ? `https://us.myjam.store/store/${state.priceCode}/products` : `https://us.myjam.store/products`}
    ...
    >
      <img
        src={`https://res.cloudinary.com/${process.env.GATSBY_CLOUDINARY_KEY}/image/upload/${process.env.GATSBY_CLOUDINARY_PATH}/usCatalog/${item.sku}.jpg`}
        alt={item.name}
      />
      <h3 className="price">
      ...
      <QuantityBoxMobile>
        ...
        <div>
          <button
            ...
            data-item-url={!!item[state.priceCode] ? `https://us.myjam.store/store/${state.priceCode}/products` : `https://us.myjam.store/products`}
